...
const steps = [
  { num: '01', icon: '📝', title: 'Register',      desc: 'Create your WASAC account online in under 2 minutes.' },
  { num: '02', icon: '💳', title: 'Get Your Card', desc: 'Collect your prepaid WASAC card from your nearest agent.' },
  { num: '03', icon: '💧', title: 'Fetch Water',   desc: 'Tap your card at any water kiosk and receive clean water instantly.' },
];
