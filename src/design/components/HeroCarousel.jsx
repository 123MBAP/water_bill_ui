  ...
  return (
    <section className={`relative overflow-hidden bg-gradient-to-br ${slide.from} ${slide.via} to-white transition-colors duration-700`}>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div
          className={`landing-hero-wrap flex flex-col-reverse lg:flex-row items-center gap-5 sm:gap-8 lg:gap-12 transition-all duration-300 ${
          ...
          <div className="flex-1 text-center lg:text-left max-w-xl mx-auto lg:mx-0 w-full">
            ...
            <div className="mt-5 sm:mt-6 flex flex-col sm:flex-row flex-wrap gap-3 items-center justify-center lg:justify-start">
              <Link
                to="/register"
                className="btn-shine w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-bold text-white shadow-lg shadow-blue-200 transition-all duration-200 hover:bg-blue-600 hover:-translate-y-0.5 no-underline"
              >
                {slide.cta}
              ...
              <a
                href="#how-it-works"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full border-2 border-slate-200 bg-white/80 px-6 py-3 text-sm font-semibold text-darknavy no-underline transition-all duration-200 hover:border-primary hover:text-primary"
              >
                {slide.ctaSecondary}
              </a>
            </div>

            <div className="mt-4 sm:mt-5 flex flex-wrap items-center gap-3 justify-center lg:justify-start">
              {[
          ...
          {/* ── Illustration side ── */}
          <div className="flex-1 w-full max-w-[220px] sm:max-w-xs md:max-w-sm lg:max-w-md mx-auto">
            <Illustration />
          </div>
        </div>

        {/* Dot indicators — in flow so wave doesn't cover them */}
        <div className="landing-hero-dots flex justify-center gap-2">
          {slides.map((_, i) => (
            <button
              key={i}
              type="button"
      ...
      <div className="pointer-events-none absolute bottom-0 left-0 right-0">
        <svg viewBox="0 0 1440 40" xmlns="http://www.w3.org/2000/svg" className="w-full block" preserveAspectRatio="none" style={{ height: 40 }}>
