...
export default function HowItWorks() {
  ...
  return (
    <section id="how" className="bg-white py-14 sm:py-24" ref={sectionRef}>
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center reveal">
          ...
          <h2 className="mt-4 text-2xl sm:text-3xl font-black leading-tight text-darknavy md:text-4xl lg:text-5xl">
            Three Steps to Pay Your Bill
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-base sm:text-lg leading-8 text-slate-500">
            No paperwork, no queues. Just fast, secure water bill payments in minutes.
          </p>
        </div>
          ...
          {steps.map((s, i) => (
            ...
            >
              ...
              <div className="relative">
                <div className={`flex h-16 w-16 items-center justify-center rounded-2xl ${s.color} border-2 ${s.border} shadow-xl ${s.glow}`}>
                  {s.icon}
                </div>
                <span className="absolute -right-2 -top-2 flex h-6 w-6 items-center justify-center rounded-full bg-darknavy text-[10px] font-black text-white">
                  {s.step}
                </span>
              </div>
        ...
        <div className="mt-14 text-center reveal stagger-4">
          <button className="btn-shine w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full bg-primary px-8 py-4 text-base font-bold text-white shadow-lg shadow-blue-200 transition-all duration-200 hover:bg-blue-600 hover:-translate-y-0.5 hover:shadow-xl">
