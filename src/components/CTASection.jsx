...
export default function CTASection({ openModal }) {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-primary via-blue-600 to-cyan-500 py-14 sm:py-24" ref={sectionRef}>
      {/* Decorative blobs */}
      ...
      {/* Floating water drops — hidden on small screens so they don't clutter text */}
      <div className="pointer-events-none hidden sm:block absolute left-12 top-12 animate-drop-1 opacity-40">
        <svg viewBox="0 0 20 24" className="h-6 w-5 text-white" fill="currentColor">
          <path d="M10 0C7 6 2 10 2 15a8 8 0 0 0 16 0C18 10 13 6 10 0Z" />
        </svg>
      </div>
      <div className="pointer-events-none hidden sm:block absolute right-16 top-8 animate-drop-2 opacity-30">
        <svg viewBox="0 0 20 24" className="h-4 w-3 text-white" fill="currentColor">
          <path d="M10 0C7 6 2 10 2 15a8 8 0 0 0 16 0C18 10 13 6 10 0Z" />
        </svg>
      </div>
      <div className="pointer-events-none hidden sm:block absolute left-1/4 bottom-10 animate-drop-3 opacity-25">
        <svg viewBox="0 0 20 24" className="h-5 w-4 text-white" fill="currentColor">
          <path d="M10 0C7 6 2 10 2 15a8 8 0 0 0 16 0C18 10 13 6 10 0Z" />
        </svg>
      </div>
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <div className="reveal mt-8 sm:mt-10 flex flex-col sm:flex-row gap-3 sm:gap-4 items-center justify-center stagger-3">
          <button
            ...
            className="btn-shine w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full bg-white px-7 py-3.5 sm:px-9 sm:py-4 text-sm sm:text-base font-black text-primary shadow-2xl shadow-blue-900/20 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-white/30 active:scale-95"
          >
            Create Free Account
          ...
          <button
            onClick={() => openModal && openModal('login')}
